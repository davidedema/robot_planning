...
void generateMovementPath(nav_msgs::msg::Path &shelfino1_nav2, nav_msgs::msg::Path &shelfino2_nav2, plan_t points_path1, plan_t points_path2, pose_t pose_shellfino1, pose_t pose_shellfino2, pose_t pose_gate, multi_polygon_t map, std::vector<polygon_t> obstacles);
