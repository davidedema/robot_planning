...
int main(int argc, char **argv)
{
  ...
  while (!solved_collision)
  {
    ...
    if (collision_index != -1)
    {
      ...
      {
        shelfino1_path = _orchestrator_shelfino1.reschedule_path(shelfino1_path, start_shelfino1, 1, map);
        shelfino1_path.erase(shelfino1_path.begin());
        shelfino1_path.erase(shelfino1_path.end());
        try
        {
      ...
      else
      {
        ...
        shelfino2_path = _orchestrator_shelfino1.reschedule_path(shelfino2_path, start_shelfino2, 1, map);
        shelfino2_path.erase(shelfino2_path.begin());
        shelfino2_path.erase(shelfino2_path.end());
        try
        {
